...
let [idOfProgrammers, setIdOfPogrammers] = useState(null)
  const getNameOfFeatured = () => {
    ...
    return programmers.find(pr => pr.id == idOfProgrammers).name
  };

  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: idOfProgrammers ? 'gold' : 'royalblue', // 🤔 color turns to gold, when celebrating
  };
